...
@section('content-header')
    <h1>{{ $server->name }}<small>{{ Illuminate\Support\Str::limit($server->description) }}</small></h1>
    <ol class="breadcrumb">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>Current Egg</td>
                                <td>
                                    <a href="{{ route('admin.nests.view', $server->egg->nest_id) }}">{{ $server->egg->nest->name }}</a> ::
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="small-box bg-gray">
                            <div class="inner">
                                <h3>{{ Illuminate\Support\Str::limit($server->user->username, 16) }}</h3>
                                <p>Server Owner</p>
                            </div>
                    ...
                    <div class="col-sm-12">
                        <div class="small-box bg-gray">
                            <div class="inner">
                                <h3>{{ Illuminate\Support\Str::limit($server->node->name, 16) }}</h3>
                                <p>Server Node</p>
                            </div>
