...
// If we're using HMR use a unique hash per page reload so that we're always doing cache busting.
const hash = import.meta.hot ? Date.now().toString(16) : process.env.VITE_BUILD_HASH;
