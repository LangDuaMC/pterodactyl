...
import { faChevronRight, faChevronDown, faFileAlt, faFileArchive, faFileImport, faFolder, faFolderOpen } from '@fortawesome/free-solid-svg-icons';
...
const TreeNode = React.memo(
  ({ depth, name, path, isFile, isSymlink, mimetype, isArchiveType: isArchive, currentDirectory, onNavigate, onOpenFile }: TreeNodeProps) => {
